...
if n1 <= n2 <= n3:
    ...
    print('O menor é {} e o maior é {}.'.format(n1, n3))

elif n1 <= n3 <= n2:
    print('A ordem crescente é: {},{},{}'.format(n1, n3, n2))
    print('O menor é {} e o maior é {}.'.format(n1, n2))

elif n2 <= n3 <= n1:
    print('A ordem crescente é: {},{},{}'.format(n2, n3, n1))
    print('O menor é {} e o maior é {}.'.format(n2, n1))

elif n2 <= n1 <= n3:
    print('A ordem crescente é: {},{},{}'.format(n2, n1, n3))
    print('O menor é {} e o maior é {}.'.format(n2, n3))

elif n3 <= n2 <= n1:
    print('A ordem crescente é: {},{},{}'.format(n3, n2, n1))
    print('O menor é {} e o maior é {}.'.format(n3, n1))

elif n3 <= n1 <= n2:
    print('A ordem crescente é: {},{},{}'.format(n3, n1, n2))
    print('O menor é {} e o maior é {}.'.format(n3, n2))
