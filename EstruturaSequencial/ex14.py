...
peso = float(input('Digite a quantidade de peixes hoje:\n '))
if peso > 50:
    excesso = (peso - 50)
    valor = excesso * 4
    print('Você excedeu a quantidade {:.2f} Kilos.O valor a ser pago é de {:.2f} Reais.'.format(excesso, valor))
else:
    print('Você não excedeu a quantidade de Kilos.')
